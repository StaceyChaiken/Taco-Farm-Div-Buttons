...
// gloabl variable which starts our taco count at zero
let tacoNum = 0; 
...
function addTaco() {
	//increment the tacoNum variable by one
	tacoNum++;
	...
	// first create the elements node for an <img>
 	...
 	document.getElementById("tacoFarm").appendChild(newImg);
		...
		// remove the taco button from the page
...
function resetTacos() {
	...
	document.getElementsByTagName("h3")[0].style.marginBottom = "35px";
